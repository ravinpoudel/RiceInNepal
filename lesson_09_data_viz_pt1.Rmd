...
Let's read in our tomato yiled data for learning various plots in R. We will use the data maniputation techniques, that we have learned before, and use it for visulization as well.
