...
We will introduce the concepts of *descriptive* and *inferential statistic*s, and briefly discuss a few most basic ways of getting an overall high-level view at the data at hand (descriptive approach). Towards this end, we will also introduce a few additional R commands and useful plots.
...
**How to get the figure with comparing means with statistical significane added?**
